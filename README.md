...
`javascript:(function(){$.getScript('https://rawgit.com/AlvinSeville/PlugDjBot/master/basicBot.js');})();`

If this does not work, go to https://raw.githubusercontent.com/AlvinSeville/PlugDjBot/master/basicBot.js and copy paste its content into your console (accessible in chrome by pressing F12) when on plug.dj in your community.
...
Blacklists
----------
Examples of blacklists can be found in [the customization repository](https://github.com/AlvinSeville/PlugDjBot/tree/master/blacklists).
...
---------------------------------------------------
basicBot can be customized to fit your needs. Please refer to [the customization repository](https://github.com/AlvinSeville/PlugDjBot) for more info.
